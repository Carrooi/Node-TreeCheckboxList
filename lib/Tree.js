...
(function() {
  ...
  Tree = (function() {
    ...
    Tree.prototype.opener = null;

    Tree.prototype.event = 'click';
    ...
    function Tree(opener, url, event) {
      var _this = this;
      this.opener = opener;
      if (url == null) {
        url = null;
      ...
      this.opener.on(this.event, function(e) {
        e.preventDefault();
        return _this.open();
      });
      if (url !== null) {
    ...
    Tree.prototype.refreshSummary = function() {
